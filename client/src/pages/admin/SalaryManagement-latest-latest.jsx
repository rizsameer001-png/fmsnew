...
import { 
  ...
  DocumentDuplicateIcon,EnvelopeIcon, PaperAirplaneIcon  // ✅ NEW - For salary slip export
...
const [showBulkEmailModal, setShowBulkEmailModal] = useState(false);
  ...
  // ✅ FIXED: Exclude customers from dropdown
...
//-------------new-----------------------
  ...
  // ✅ NEW - Export all salaries to Excel
  ...
  //==========================================================
  const handleSendEmail = (salaryId) => {
  if (window.confirm('Send salary slip to employee email?')) {
...
const handleBulkEmail = () => {
  ...
  // ✅ Filter out customers from the list (extra safety)
      ...
      <Modal isOpen={showModal} onClose={() => { setShowModal(false); setSelectedSalary(null); }} title="Salary Details" size="lg">
        {selectedSalary && (
          <div className="space-y-4">
            ...
            {/* ✅ NEW - Download Salary Slip from Modal */}
...
// Add Bulk Email button in header
<button
