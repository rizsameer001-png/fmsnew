      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
        ...
        <div className="relative px-6 pb-6">
          ...
          <div className="mt-4">
            ...
            <p className="text-gray-500 dark:text-gray-400 capitalize">Customer</p>
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center space-x-2 text-gray-600 dark:text-gray-400">
                ...
                <span>{user?.buildingId?.name || 'Not assigned'}</span>
              </div>
              {user?.address?.city && (
                <div className="flex items-center space-x-2 text-gray-600 dark:text-gray-400">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
              <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-3 text-center">
                <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">{user?.totalComplaints || 0}</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">Total Complaints</p>
              </div>
              <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-3 text-center">
                <p className="text-2xl font-bold text-green-600 dark:text-green-400">{user?.resolvedComplaints || 0}</p>
